...
#define R1 ((i_loc+1-1) * info->dr)
#define R2 ((i_loc+2-1) * info->dr)
#define R3 ((i_loc+3-1) * info->dr)
#define DR3 (info->dr*info->dr*info->dr)
...
#define S1 ((j_loc+1-1)* info->ds)
#define S2 ((j_loc+2-1) * info->ds)
#define S3 ((j_loc+3-1) * info->ds)
#define DS3 (info->ds*info->ds*info->ds)
...
#define CUB(r,s,x) (ALPHA_0(r) * BETA_0(s) * x(i_loc  ,j_m    ) +  \
		    ALPHA_1(r) * BETA_0(s) * x(i_loc+1,j_m    ) +  \
		    ALPHA_2(r) * BETA_0(s) * x(i_loc+2,j_m    ) +  \
		    ALPHA_3(r) * BETA_0(s) * x(i_loc+3,j_m    ) +  \
		    ...
		    ALPHA_0(r) * BETA_3(s) * x(i_loc  ,j_p    ) +  \
		    ALPHA_1(r) * BETA_3(s) * x(i_loc+1,j_p    ) +  \
		    ALPHA_2(r) * BETA_3(s) * x(i_loc+2,j_p    ) +  \
		    ALPHA_3(r) * BETA_3(s) * x(i_loc+3,j_p    ) )

#define CUB_R(r,s,x) (D_ALPHA_0(r) * BETA_0(s) * x(i_loc  ,j_m    ) +  \
		      D_ALPHA_1(r) * BETA_0(s) * x(i_loc+1,j_m    ) +  \
		      D_ALPHA_2(r) * BETA_0(s) * x(i_loc+2,j_m    ) +  \
		      D_ALPHA_3(r) * BETA_0(s) * x(i_loc+3,j_m    ) +  \
		      ...
		      D_ALPHA_0(r) * BETA_3(s) * x(i_loc  ,j_p    ) +  \
		      D_ALPHA_1(r) * BETA_3(s) * x(i_loc+1,j_p    ) +  \
		      D_ALPHA_2(r) * BETA_3(s) * x(i_loc+2,j_p    ) +  \
		      D_ALPHA_3(r) * BETA_3(s) * x(i_loc+3,j_p    ) )

#define CUB_S(r,s,x) (ALPHA_0(r) * D_BETA_0(s) * x(i_loc  ,j_m    ) +  \
		      ALPHA_1(r) * D_BETA_0(s) * x(i_loc+1,j_m    ) +  \
		      ALPHA_2(r) * D_BETA_0(s) * x(i_loc+2,j_m    ) +  \
		      ALPHA_3(r) * D_BETA_0(s) * x(i_loc+3,j_m    ) +  \
